...
export const LabIcon = ({ width = '3.2rem', height = '3.2rem', className }) => {
    return (
        <svg
            className={className}
            width={width}
...
export const LabActiveIcon = ({ width = '3.2rem', height = '3.2rem', className }) => {
    return (
        <svg
            className={className}
            width={width}
...
export const HasTagIcon = ({ width = '1.6rem', height = '1.6rem', className }) => {
    return (
        <svg
            className={className}
            width={width}
...
export const HasTagMusic = ({ width = '1.6rem', height = '1.6rem', className }) => {
    return (
        <svg
            width={width}
            className={className}
...
export const CheckIconSuccess = ({ width = '1.4rem', height = '1.4rem', className }) => {
    return (
        <svg
            width={width}
            height={height}
